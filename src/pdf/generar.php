...
$pdf->image("../../assets/img/logoo.png", 75, 15, 20, 15, 'PNG');
...
$pdf->Cell(90, 5, "Datos del cliente", 1, 1, 'C', 1);
...
$pdf->SetFont('Arial', 'B', 8);
$pdf->SetTextColor(255, 255, 255);
$pdf->Cell(90, 5, "Detalle de Producto", 1, 1, 'C', 1);
$pdf->SetTextColor(0, 0, 0);
...
$pdf->Cell(85, 5, 'Descuento Total', 0, 1, 'R');
$pdf->SetFont('Arial', '', 10);
$pdf->Cell(85, 5, number_format($desc, 2, '.', ','), 0, 1, 'R');
$pdf->SetFont('Arial', 'B', 10);
$pdf->Cell(85, 5, 'Total Pagar', 0, 1, 'R');
$pdf->SetFont('Arial', '', 10);
$pdf->Cell(85, 5, number_format($total, 2, '.', ','), 0, 1, 'R');
