...
if (!empty($_POST)) {
    ...
    if (empty($codigo) || empty($descripcion) || empty($precio) || $precio <  0 || empty($cantidad) || $cantidad <  0) {
        ...
        if (empty($id)) {
            ...
            if ($result > 0) {
                ...
                $query_insert = mysqli_query($conexion, "INSERT INTO producto(codigo,descripcion,precio,existencia) values ('$codigo', '$descripcion', '$precio', '$cantidad')");
                if ($query_insert) {
            ...
            $query_update = mysqli_query($conexion, "UPDATE producto SET codigo = '$codigo', descripcion = '$descripcion', precio= $precio, existencia = $cantidad WHERE codproducto = $id");
            if ($query_update) {
                $alert = '<div class="alert alert-success alert-dismissible fade show" role="alert">
                        Producto Modificado
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            ...
            <div class="col-md-12">
                <form action="" method="post" autocomplete="off" id="formulario">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                <label for="descripcion" class=" text-dark font-weight-bold">Descripcion</label>
